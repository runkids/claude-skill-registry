...
description: Create distinctive, production-grade dashboard interfaces for Fixlify. Automatically activates when building UI components, pages, dashboards, forms, or any visual interface. Uses Fixlify design system with shadcn/ui, Tailwind CSS, and React patterns.
version: 1.0.0
author: Fixlify Team
tags: [dashboard, ui, design, react, tailwind, shadcn]
---

# Fixlify Dashboard Design Skill

Create distinctive, production-grade dashboard interfaces for Fixlify field service management platform. Every UI should feel professional, modern, and purpose-built for service professionals and field teams.
