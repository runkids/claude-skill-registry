---
name: puppeteer
description: "Puppeteer browser automation for web scraping, testing, and screenshots. Control headless Chrome for automated workflows. Use for headless browsers, web scraping, E2E testing, or PDF generation."
---
...
| Feature         | Description                |
| --------------- | -------------------------- |
| **Navigation**  | Page loading, clicking     |
| **Screenshots** | Full page, element capture |
| **PDF**         | Generate PDFs              |
| **Scraping**    | Extract page data          |
...
// XPath
const [button] = await page.$x('//button[contains(text(), "Click")]');
await button.click();
```
