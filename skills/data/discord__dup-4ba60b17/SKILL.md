...
Use `discord` to manage messages, reactions, threads, polls, and moderation. You can disable groups via `discord.actions.*` (defaults to enabled, except roles/moderation). The tool uses the bot token configured for MarketBot.
...
```json
{
  ...
  "guildId": "999",
  "name": "marketbot_wave",
  "description": "MarketBot waving hello",
  "tags": "👋",
