...
- String Table: `skills/devian/33-string-table/SKILL.md` → `.../string/ndjson/...`
- 일반 Table: `skills/devian/32-json-row-io/SKILL.md` → `.../ndjson/...`
...
- Consumer: `skills/devian/32-json-row-io/SKILL.md` (일반 Table)
- Consumer: `skills/devian/33-string-table/SKILL.md` (String Table)
