...
╠═══════════════════════════════════════════════════════════════════════╣
║                                                                       ║
║  Please review the architecture before I create the PRD:              ║
║                                                                       ║
║  📊 Diagrams Created:                                                 ║
║     ✓ Context Diagram  - docs/discovery/diagrams/context.mmd         ║
║     ✓ Container Diagram - docs/discovery/diagrams/container.mmd      ║
║     ✓ Data Flow Diagram - docs/discovery/diagrams/dataflow.mmd       ║
║     ✓ Deployment Diagram - docs/discovery/diagrams/deployment.mmd    ║
║                                                                       ║
║  📄 ADRs Created: [count]                                             ║
║                                                                       ║
...
║                                                                       ║
║  To proceed, please say:                                              ║
║     "Architecture approved" - to continue to PRD synthesis            ║
║     "Change [diagram/decision]" - to modify before proceeding         ║
║                                                                       ║
╚═══════════════════════════════════════════════════════════════════════╝
```
